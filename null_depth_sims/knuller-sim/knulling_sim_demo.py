...
# dra, ddec, con = 2, 1, 10 ** (-2.63)  # test companion!
...
We introduce some amount of piston residuals: prms = {prms} nm and for each
...
myk.plot_fov_map(kcmap, ftitle="Kernel colinearity map ", cmap=mycmap, cbar=True)
...
myk.plot_fov_map(knorm, ftitle="Kernel norm map", cmap=mycmap, cbar=True)
